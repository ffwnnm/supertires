...
//                "entriesList",
//                new PropertyModel(BlogPage.this, "entries"),
...
//        add(listContainer);
    ...
    public IModel getKeywords() {
        return new StringResourceModel("keywords", BlogPage.this, null);
    }

    @Override
    public IModel getDescription() {
        return new StringResourceModel("description", BlogPage.this, null);
    }

    @Override
    public IModel getPageTitle() {
        return new StringResourceModel("title", BlogPage.this, null);
    }
